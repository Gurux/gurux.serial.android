...
public class GXSerial implements IGXMedia2, AutoCloseable {
     ...
     * Media listeners.
     */
    private List<IGXMediaListener> mMediaListeners = new ArrayList<IGXMediaListener>();

    /**
     * Serial port listeners.
     */
    private List<IGXSerialListener> mPortListeners = new ArrayList<IGXSerialListener>();
